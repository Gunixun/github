...
import gunixun.github.databinding.FragmentRecyclerItemProfileBinding
...
class ProfilesAdapter : RecyclerView.Adapter<ProfilesAdapter.ProfileViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfileViewHolder {
        val binding = FragmentRecyclerItemProfileBinding.inflate(
    ...
    override fun onBindViewHolder(
        ...
        if (payloads.isNotEmpty()) {
            ...
            if (oldData.name != newData.name){
                FragmentRecyclerItemProfileBinding.bind(holder.itemView).nameTextView.text =
                    newData.name
            }

            if (oldData.login != newData.login){
                FragmentRecyclerItemProfileBinding.bind(holder.itemView).loginTextView.text =
                    newData.login
            }
    ...
    inner class ProfileViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bind(data: Profile) {
            FragmentRecyclerItemProfileBinding.bind(itemView).apply {
